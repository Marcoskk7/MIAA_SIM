...
def create_cylinder(
    ...
    builder.add_cylinder_visual(radius=radisu, material=color)
...
def main():
    ...
    builder.add_convex_collision_from_file(
        filename="./asset/object/banana/collision.obj"
    )
    builder.add_visual_from_file(filename="./asset/object/banana/visual.glb")
